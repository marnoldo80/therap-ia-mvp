  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === 'signup') {
        ...
        // Attendi salvataggio cookie e redirect
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="••••••••"
            />
            {mode === 'signup' && <p className="text-xs text-gray-500 mt-1">Minimo 6 caratteri</p>}
          </div>
        ...
        <div className="mt-6 text-center">
          <a href={`/login/terapeuta?mode=${mode === 'signup' ? 'login' : 'signup'}`} className="text-blue-600 hover:text-blue-700 text-sm font-medium">
            {mode === 'signup' ? 'Hai già un account? Accedi' : 'Non hai un account? Registrati'}
          </a>
          <br />
          <a href="/login"
cat > app/login/terapeuta/page.tsx << 'EOF'
'use client';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
        ...
        <div className="mt-6 text-center">
          ...
          <br />
          <a href="/login" className="text-gray-500 hover:text-gray-700 text-sm block mt-2">
            ← Torna alla scelta
          </a>
        </div>
      </div>
