...
export default function PatientConsentPage() {
  ...
  // Canvas drawing functions (identiche)
    ...
    return (
      <div className="max-w-4xl mx-auto p-6">
        <div className="bg-red-50 border border-red-200 rounded p-4 text-red-700">
          ...
          <p className="text-sm text-gray-600 mt-2">Controlla che il link sia corretto o contatta il tuo terapeuta.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      <div className="text-center py-6 bg-blue-50 rounded-lg mb-6">
        <h1 className="text-2xl font-bold text-blue-800">Consenso Informato - Firma Paziente</h1>
        <p className="text-blue-600 mt-2">
          Ciao <strong>{patient?.display_name}</strong>, per favore rivedi il consenso firmato dal tuo terapeuta e aggiungi la tua firma alla fine.
        </p>
      </div>

      {/* SEZIONE 1: CONSENSO INFORMATO - IDENTICA */}
      ...
      {/* SEZIONE 2: INFORMATIVA TRATTAMENTO DATI - IDENTICA */}
      <div className="bg-white border rounded-lg p-8">
        ...
        <div className="space-y-4 text-sm leading-relaxed">
          ...
          <div className="mt-6 p-4 border rounded bg-yellow-50">
            <h4 className="font-semibold mb-3">Scelta già effettuata per la trasmissione dati fiscali (Sistema Tessera Sanitaria):</h4>
      ...
      {/* SEZIONE FIRME - MODIFICATA PER PAZIENTE */}
      <div className="bg-white border rounded-lg p-8">
        ...
        <div className="grid grid-cols-2 gap-8">
          <div>
            ...
            <div className="mt-6">
              <h4 className="font-semibold mb-3">Firma del Terapeuta (già firmato):</h4>
          ...
          <div>
            <h4 className="font-semibold mb-3">La tua firma (Paziente):</h4>
